...
const Manager_Users: React.FC = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('http://159.89.160.186/api/all_users/', {
        method: 'POST',
        headers: {
  ...
  const fetchSales = async () => {
    try {
      const response = await fetch('http://159.89.160.186/api/sales/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const Create_User = async () => {
    try {
      const response = await fetch('http://159.89.160.186/api/create_user/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const createSales = async () => {
    if (inp_sales_name && inp_sales_phone_number) {
      try {
        const response = await fetch('http://159.89.160.186/api/create-sales/', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },

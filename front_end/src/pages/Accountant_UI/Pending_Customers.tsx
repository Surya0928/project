...
const Pending_Accountant_Customers: React.FC = () => {
  ...
  const get_customers = async () => {
    setLoading(true)
    try {
      const response = await fetch('http://159.89.160.186:8000/accountant_pending_customer_data/', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='font-sans flex h-screen w-screen justify-between items-center'>
      ...
      <Accountant_Side_Bar current_page="Pending_Customers"/>
        ...
        {show_customer_popup ? (
          ...
          <div className='h-full overflow-y-auto no-scrollbar w-full flex flex-col py-6 space-y-6'>
            ...
            <div className='flex w-full h-auto items-center justify-between px-10'>
              <div className='text-4xl font-bold'>Pending Customers</div>
...
export default Pending_Accountant_Customers;
